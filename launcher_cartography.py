...
class Launcher:
    def __init__(self):
        ...
        drones = [MyDrone(DEBUG_ID = ID_DRONE_SUIVI, identifier=i, misc_data=misc_data, texture = COULEUR_DRONE_SUIVI if (i == ID_DRONE_SUIVI) else COULEUR_DEFAUT)
                  for i in
